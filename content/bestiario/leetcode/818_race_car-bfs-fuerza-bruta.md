...
## Técnicas utilizadas
Búsqueda en Anchura [BFS](): Exploración nivel por nivel con una [Cola](content/grimorio/data-structures/queue.md), para encontrar la ruta más corta en un espacio de estados.
...
- **Memorización de estados visitados:** Se descartan los estados `(posición, velocidad)` que ya fueron procesados, guardados en un [Set](content/grimorio/data-structures/set.md).
